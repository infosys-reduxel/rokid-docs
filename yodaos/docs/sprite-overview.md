...
> This FAQ was refreshed from the upstream `developerdoc.rokid.com/sprite` page (fetched 2026-08-31). The upstream page has reverted to a short, CXR-M/CXR-S-focused Q&A list, replacing the more detailed CXR-L session-construction and bare-metal Q&As that were present as of the 2026-06-08 fetch. Maven `client-l` is at 1.1.2 as of 2026-08-28 (see [cxr-l/release-notes.md](../../cxr-l/release-notes.md)); the portal has not published a changelog for the 1.1.x line yet.

**Q: What are the main capabilities of the CXR-M SDK?**

**A:** A mobile app built with the CXR-M SDK can communicate with Rokid Glasses to obtain audio and video from the glasses, customize the implementation of existing scenes on the glasses, and — when paired with the Rokid CXR-S SDK — exchange custom commands.

**Q: Which devices does the CXR-M SDK currently support?**

**A:** Currently the CXR-M SDK is only provided as an Android mobile SDK.

**Q: What are the main capabilities of the CXR-S SDK?**

**A:** The CXR-S SDK provides access to the data channel on YodaOS-Sprite, letting custom commands be passed to the CXR-M SDK over that data channel.

**Q: Do I need to enable developer permissions on Rokid Glasses if I'm only building a mobile app with the CXR-M SDK?**
