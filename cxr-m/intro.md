...
See [release-notes.md](release-notes.md) for the full version history. The current **publicly documented** release is **v1.1.0** (2026-04-01); Maven additionally publishes **v1.2.2** (2026-06-09) but Rokid has not released a changelog for the 1.1.x / 1.2.x line as of 2026-06-13.
...
> Source: `https://custom.rokid.com/prod/rokid_web/57e35cd3ae294d16b1b8fc8dcbb1b7c7/pc/cn/9d9dea4799ca4dd2a1176fedb075b6f2.html` (v1.0.1, scraped 2026-06-13)
