...
| **Maven Artifact (latest)** | `com.rokid.cxr:client-l:1.1.1` (2026-08-15); official changelog at `developerdoc.rokid.com/sdk` still shows 1.0.4 |
| **Size** | 171,369 bytes (1.1.1 AAR); 70,543 bytes (1.0.4 AAR); 65,494 bytes (1.0.3 AAR) |
| **Min SDK** | 28 (1.0.1–1.0.2) / **31** (1.0.3+, per docs; AAR manifest itself still declares 28) |
| **Target SDK** | 28 (1.0.1–1.0.3); not declared in AAR from 1.0.4 onward |
| **Dependencies (1.1.1)** | cxr-service-bridge 1.0-20260715.121510-107, Kotlin stdlib 1.9.0, Gson 2.10.1, kotlinx-coroutines-android 1.9.0 (new) |
| **Repository** | `https://maven.rokid.com/repository/maven-public/` |
