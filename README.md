...
| **Maven Artifact (latest documented)** | `com.rokid.cxr:client-l:1.0.4` (official changelog 2026-06-29) — Maven also lists an undocumented `1.1.0` as of 2026-07-02, not yet covered |
